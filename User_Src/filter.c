...
float LPF2pApply_1(float sample)
{
	...
	{
		delay_element_0 = sample - _delay_element_11 * _a11
				- _delay_element_21 * _a21;
		// do the filtering
		...
		output = delay_element_0 * _b01 + _delay_element_11 * _b11
				+ _delay_element_21 * _b21;
...
float LPF2pApply_2(float sample)
{
	...
	{
		delay_element_0 = sample - _delay_element_12 * _a12
				- _delay_element_22 * _a22;
		// do the filtering
		if (isnan(delay_element_0) || isinf(delay_element_0))
		{
			// don't allow bad values to propogate via the filter
		...
		output = delay_element_0 * _b02 + _delay_element_12 * _b12
				+ _delay_element_22 * _b22;
...
float LPF2pApply_3(float sample)
{
	...
	{
		delay_element_0 = sample - _delay_element_13 * _a13
				- _delay_element_23 * _a23;
		// do the filtering
		if (isnan(delay_element_0) || isinf(delay_element_0))
		{
			// don't allow bad values to propogate via the filter
		...
		output = delay_element_0 * _b03 + _delay_element_13 * _b13
				+ _delay_element_23 * _b23;
...
float LPF2pApply_4(float sample)
{
	...
	{
		delay_element_0 = sample - _delay_element_14 * _a14
				- _delay_element_24 * _a24;
		// do the filtering
		if (isnan(delay_element_0) || isinf(delay_element_0))
		{
			// don't allow bad values to propogate via the filter
		...
		output = delay_element_0 * _b04 + _delay_element_14 * _b14
				+ _delay_element_24 * _b24;
...
float LPF2pApply_5(float sample)
{
	...
	{
		delay_element_0 = sample - _delay_element_15 * _a15
				- _delay_element_25 * _a25;
		// do the filtering
		if (isnan(delay_element_0) || isinf(delay_element_0))
		{
			// don't allow bad values to propogate via the filter
		...
		output = delay_element_0 * _b05 + _delay_element_15 * _b15
				+ _delay_element_25 * _b25;
...
float LPF2pApply_6(float sample)
{
	...
	{
		delay_element_0 = sample - _delay_element_16 * _a16
				- _delay_element_26 * _a26;
		// do the filtering
		if (isnan(delay_element_0) || isinf(delay_element_0))
		{
			// don't allow bad values to propogate via the filter
		...
		output = delay_element_0 * _b06 + _delay_element_16 * _b16
				+ _delay_element_26 * _b26;
