...
RC_GETDATA RC_DATA; //= {0,0,0,0}, RC_DATA_RAW = {0,0,0,0}; // RC_DATA is processed desirable Stone

extern uint32_t lastGetRCTime;

// Function name: ReceiveDataFormNRF ()
// Input: None
// output: none
// Description: Assign the received 2.4G remote control data to the corresponding variable
// Author: Ma Jun
void ReceiveDataFormNRF(void)
{
	if ((NRF24L01_RXDATA[0] == '$') && (NRF24L01_RXDATA[1] == 'M')
			&& (NRF24L01_RXDATA[2] == '<'))
	{
